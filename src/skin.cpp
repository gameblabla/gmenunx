...
std::string Skin::toString() {
    ...
    vec.push_back("");
    vec.push_back(StringUtils::stringFormat("version=%i", version));
    vec.push_back("");

    vec.push_back("# font sizes");
    vec.push_back("");
    vec.push_back(StringUtils::stringFormat("fontSize=%i", fontSize));
    vec.push_back(StringUtils::stringFormat("fontSizeTitle=%i", fontSizeTitle));
    vec.push_back(StringUtils::stringFormat("fontSizeSectionTitle=%i", fontSizeSectionTitle));
    vec.push_back("");

    vec.push_back("# number of rows and columns to show in launcher view");
    vec.push_back("");
    vec.push_back(StringUtils::stringFormat("linkRows=%i", numLinkRows));
    vec.push_back(StringUtils::stringFormat("linkCols=%i", numLinkCols));
    vec.push_back("");
    ...
    vec.push_back("");
    vec.push_back(StringUtils::stringFormat("sectionTitleBarSize=%i", sectionTitleBarSize));
    vec.push_back(StringUtils::stringFormat("sectionTitleBarImage=\"%s\"", sectionTitleBarImage.c_str()));
    vec.push_back("");
    ...
    vec.push_back("");
    vec.push_back(StringUtils::stringFormat("sectionBar=%i", sectionBar));
    vec.push_back("");
    ...
    vec.push_back("");
    vec.push_back(StringUtils::stringFormat("showSectionIcons=%i", showSectionIcons));
    vec.push_back("");
    ...
    vec.push_back("");
    vec.push_back(StringUtils::stringFormat("sectionInfoBarSize=%i", sectionInfoBarSize));
    vec.push_back(StringUtils::stringFormat("sectionInfoBarImage=\"%s\"", sectionInfoBarImage.c_str()));
    vec.push_back(StringUtils::stringFormat("sectionInfoBarVisible=%i", sectionInfoBarVisible));
    vec.push_back("");
    ...
    vec.push_back("");
    vec.push_back(StringUtils::stringFormat("menuTitleBarHeight=%i", menuTitleBarHeight));
    vec.push_back(StringUtils::stringFormat("menuInfoBarHeight=%i", menuInfoBarHeight));
    vec.push_back("");
    ...
    vec.push_back("");
    vec.push_back(StringUtils::stringFormat("previewWidth=%i", previewWidth));
    vec.push_back("");
    ...
    vec.push_back("");
    vec.push_back(StringUtils::stringFormat("linkDisplayMode=%i", linkDisplayMode));
    vec.push_back("");

    vec.push_back("# display the clock in the section title bar or not");
    vec.push_back("");
    vec.push_back(StringUtils::stringFormat("showClock=%i", showClock));
    vec.push_back("");

    vec.push_back("# display the loader on first boot, if there is one");
    vec.push_back("");
    vec.push_back(StringUtils::stringFormat("showLoader=%i", showLoader));
    vec.push_back("");

    vec.push_back("# display the battery icon or percentage");
    vec.push_back("");
    vec.push_back(StringUtils::stringFormat("showBatteryIcons=%i", showBatteryIcons));
    vec.push_back("");
    ...
    vec.push_back("");
    vec.push_back(StringUtils::stringFormat("skinBackdrops=%i", skinBackdrops));
    vec.push_back("");
    ...
    vec.push_back("");
    vec.push_back(StringUtils::stringFormat("scaleableHighlightImage=%i", scaleableHighlightImage));
    vec.push_back("");
    ...
    vec.push_back("");
    vec.push_back(StringUtils::stringFormat("wallpaper=\"%s\"", wallpaper.c_str()));
    vec.push_back("");

    vec.push_back("# force skin aspects to grayscale");
    vec.push_back("# imagesToGrayscale covers wallpapers, previews, backdrops");
    vec.push_back("");
    vec.push_back(StringUtils::stringFormat("imagesToGrayscale=%i", imagesToGrayscale));
    vec.push_back(StringUtils::stringFormat("iconsToGrayscale=%i", iconsToGrayscale));
    vec.push_back("");

    vec.push_back("# colours section starts");
    vec.push_back("");
    vec.push_back(StringUtils::stringFormat("background=%s", rgbatostr(colours.background).c_str()));
    vec.push_back(StringUtils::stringFormat("listBg=%s", rgbatostr(colours.listBackground).c_str()));
    vec.push_back(StringUtils::stringFormat("titleBarBg=%s", rgbatostr(colours.titleBarBackground).c_str()));
    vec.push_back(StringUtils::stringFormat("infoBarBg=%s", rgbatostr(colours.infoBarBackground).c_str()));
    vec.push_back(StringUtils::stringFormat("selectionBg=%s", rgbatostr(colours.selectionBackground).c_str()));
    vec.push_back(StringUtils::stringFormat("messageBoxBg=%s", rgbatostr(colours.msgBoxBackground).c_str()));
    vec.push_back(StringUtils::stringFormat("messageBoxBorder=%s", rgbatostr(colours.msgBoxBorder).c_str()));
    vec.push_back(StringUtils::stringFormat("messageBoxSelection=%s", rgbatostr(colours.msgBoxSelection).c_str()));
    vec.push_back(StringUtils::stringFormat("font=%s", rgbatostr(colours.font).c_str()));
    vec.push_back(StringUtils::stringFormat("fontOutline=%s", rgbatostr(colours.fontOutline).c_str()));
    vec.push_back(StringUtils::stringFormat("fontAlt=%s", rgbatostr(colours.fontAlt).c_str()));
    vec.push_back(StringUtils::stringFormat("fontAltOutline=%s", rgbatostr(colours.fontAltOutline).c_str()));
...
std::vector<std::string> Skin::getWallpapers() {
	...
	StringUtils::split(vfilter, ".png,.jpg,.jpeg,.bmp", ",");
                ...
                try {
                    ...
                    try {
                        if (name == "version") {
                            ...
                            sectionTitleBarImage = StringUtils::stripQuotes(value);
                            ...
                            sectionTitleBarImage = StringUtils::trim(sectionTitleBarImage);
                        } else if (name == "sectioninfobarsize") {
                            sectionInfoBarSize = atoi(value.c_str());
                        } else if (name == "sectioninfobarimage") {
                            sectionInfoBarImage = StringUtils::stripQuotes(value);
                            ...
                            sectionInfoBarImage = StringUtils::trim(sectionInfoBarImage);
                            ...
                            menuInfoBarImage = StringUtils::stripQuotes(value);
                            ...
                            menuInfoBarImage = StringUtils::trim(menuInfoBarImage);
                        } else if (name == "menutitlebarheight") {
                            menuTitleBarHeight = atoi(value.c_str());
                        } else if (name == "menutitlebarimage") {
                            menuTitleBarImage = StringUtils::stripQuotes(value);
                            ...
                            menuTitleBarImage = StringUtils::trim(menuTitleBarImage);
                            ...
                            wallpaper = StringUtils::stripQuotes(value);
